...
namespace ShoppingCart.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.ProductCategory.Include(p => p.Category).Include(p => p.Product);
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductId,CategoryId")] ProductCategory productCategory)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Category, "Id", "Id", productCategory.CategoryId);
            ViewData["ProductId"] = new SelectList(_context.Product, "Id", "Description", productCategory.ProductId);
            return View(productCategory);
        }
